...
function ContactsList() {
  ...
  <div  className="bg-panel-header-background flex items-center px-3 py-1  rounded-lg flex-grow mx-4">
        <div>
    ...
    </div>
    {
      Object.entries(searchContacts).map(([initialLetter,userList])=>{
         return (  <div key={Date.now()+initialLetter}>
               ...
               { userList.length && <div className="text-teal-light pl-10 py-5">
                   {
                    initialLetter
                   }
                </div>
